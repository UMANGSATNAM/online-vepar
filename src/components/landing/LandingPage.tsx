          ...
          >
            {features.map((feature) => (
              <motion.div key={feature.title} variants={fadeInUp}>
                <Card className="h-full border-emerald-100 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-50 transition-all duration-300 group">
                  <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan) => (
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <Card className={`h-full relative ${plan.popular ? 'border-emerald-300 shadow-xl shadow-emerald-100 scale-105' : 'border-emerald-100'} transition-all duration-300 hover:shadow-lg`}>
                  {plan.popular && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <Card className="h-full border-emerald-100 hover:shadow-lg hover:shadow-emerald-50 transition-all">
                  <CardHeader>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-emerald-400 max-w-md">
          ...
          <div className="border-t border-emerald-800 mt-8 pt-8 text-center text-sm text-emerald-500">
