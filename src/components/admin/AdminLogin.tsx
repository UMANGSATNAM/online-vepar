              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        required
                        className="pl-10 bg-black/40 border-white/10 text-white placeholder:text-zinc-600 focus-visible:ring-blue-500" 
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    {isLogin && <span className="text-xs text-blue-400 hover:text-blue-300 cursor-pointer">Forgot?</span>}
                  </div>
                  <div className="relative">
                ...
                <Button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] transition-all mt-4"
                >
